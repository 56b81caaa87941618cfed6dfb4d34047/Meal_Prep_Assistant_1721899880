...
*/
Vue.component("simple_footer_component_1721899881", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            FoodBuild: Craft Your Culinary Creations
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        FoodBuild empowers home cooks and professional chefs alike to design mouthwatering dishes. Join our community of food enthusiasts and unleash your culinary creativity!
                    </div>
                </div>
            </div>
        </footer> 
